...
class ManeuverOppositeDirection(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        if self._obstacle_type == 'vehicle':
            ...
            position_yaw = second_prop_waypoint.transform.rotation.yaw + 90 + 45
            offset_location = carla.Location(
                0.70 * second_prop_waypoint.lane_width * math.cos(math.radians(position_yaw)),
                0.70 * second_prop_waypoint.lane_width * math.sin(math.radians(position_yaw)))
